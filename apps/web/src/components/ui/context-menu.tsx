...
// Shared surface style for the root content and sub-menus: matches the Select
// dropdown (rounded, hairline ring, popover background).
const MENU_SURFACE =
  'bg-popover text-popover-foreground ring-foreground/10 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 z-50 min-w-[9rem] origin-(--radix-context-menu-content-transform-origin) overflow-hidden rounded-2xl p-1 shadow-md ring-1';

// Shared row style for items, sub-triggers, checkbox and radio items.
const MENU_ITEM =
...
// Right-aligned shortcut / secondary text (e.g. the computed date on a preset).
